 ...
 * base code patterned from tutorial http://mark.random-article.com/weber/java/robocode/
 * Description:
 *	>generally strong in close range combat
 *	>has problems with running long range enemies
 *  >prone to corners
 */
